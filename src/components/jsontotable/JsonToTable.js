...
require('../../assets/css/styles/JsonToTable.css')
var JsonToTableUtils1 = require('./JsonToTableUtils')
var JsonToTableUtils2 = require('./JsonToTableUtils')
var JsonToTable = /** @class */ (function (_super) {
  ...
  function JsonToTable (props, context) {
    ...
    _this.renderObject = function (obj, header, idx) {
      ...
      var objType = JsonToTableUtils2.default.getObjectType(obj)
      switch (objType) {
        case JsonToTableUtils1.JSONObjectType.ObjectWithNonNumericKeys:
          ...
          break
        case JsonToTableUtils1.JSONObjectType.Array:
    ...
    _this.renderCell = function (params) {
      var content = params.content; var colspan = params.colspan; var isHeader = params.isHeader
      var valueDisplay = isHeader ? React.createElement('strong', null, content) : content
      return React.createElement('td', { colSpan: colspan || 0, key: '__j2t_trObj' + valueDisplay }, valueDisplay)
    }
    ...
    _this.renderRowValues = function (anArray, labels) {
      return anArray.map(function (item, idx) {
        return (React.createElement('tr', { key: '__j2t_Arr' + idx.toString() }, labels.map(function (k) {
          var isValuePrimitive = JsonToTableUtils2.default.getObjectType(k) === JsonToTableUtils1.JSONObjectType.Primitive
    ...
    _this.parseArray = function (anArray) {
      var phrase = []
      var labels = JsonToTableUtils2.default.getUniqueObjectKeys(anArray)
      if (JsonToTableUtils2.default.checkLabelTypes(labels.labels) !== 'number') {
    ...
    _this.renderRows = function (obj, labelKey) {
      return Object.keys(obj).map(function (k, idx) {
        var value = obj[k]
        var isValuePrimitive = JsonToTableUtils2.default.getObjectType(value) === JsonToTableUtils1.JSONObjectType.Primitive
